...
const Navbar = ({}: Props) => {
  return (
    ...
    >
      ...
      <div className="w-16 h-16 rounded-full flex items-center justify-center absolute right-1/2 transform translate-x-1/2 -top-8 bg-gradient-to-t from-indigo-400 via-purple-400 to-pink-400">
